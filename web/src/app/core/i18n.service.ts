...
const MESSAGES: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'motherResult.breakdown.profiles': 'Birth profiles',
    'motherResult.profiles.lagna': 'Lagna',
    'motherResult.profiles.gana': 'Gana',
  ...
  hi: {
    ...
    'motherResult.breakdown.profiles': 'जन्म प्रोफ़ाइल',
    'motherResult.profiles.lagna': 'लग्न',
    'motherResult.profiles.gana': 'गण',
